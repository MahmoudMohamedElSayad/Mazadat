...
import com.example.mazadat.data.model.DateTxt;
import com.example.mazadat.view.activity.HomeCycleActivity;
import com.example.mazadat.view.activity.UserCycleActivity;
...
import static com.example.mazadat.data.local.SharedPreferencesManger.SaveLanguage;
...
//        }
    ...
    public static void showConfirmationDialog(Activity activity,int title, int message, int posText, boolean isCancelable) {
...
//            alertDialog = new AlertDialog.Builder(HomeFragment.this).create();
            ...
            alertDialog = new androidx.appcompat.app.AlertDialog.Builder(activity).create();
...
//            Bitmap smallMarker = Bitmap.createScaledBitmap(bitmap, width, height, false);
    ...
    public static void showCalender(Context context, String title, final TextView text_view_data, final DateTxt
            data1) {
...
//                .into(imageView);
    ...
    public static void onLoadCirImageFromUrl2(ImageView imageView, String URl, Context context) {
        Glide.with(context)
                .load(URl)
                //.apply(RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.ALL))
                .into(imageView);
...
//        text.setText(ToastTitle);
    ...
    public static void setLightStatusBar(View view, Activity activity){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            activity.getWindow().setStatusBarColor(activity.getResources().getColor(R.color.status_color));
        }
    }
    public static void setLightStatusBar2(Activity activity){
