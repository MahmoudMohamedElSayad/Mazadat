...
public class Country {
    ...
    public Country() {
        ...
        COUNTRIES.add(new com.example.mazadat.utils.validation.Country("AX", "Åland Islands", "+358", 0, 1));
        ...
        COUNTRIES.add(new com.example.mazadat.utils.validation.Country("BL", "Saint Barthélemy", "+590", 0, 1));
        ...
        COUNTRIES.add(new com.example.mazadat.utils.validation.Country("RE", "Réunion", "+262", 0, 1));
